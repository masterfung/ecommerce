...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'contact_contact', 'fullname',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'contact_contact', 'fullname')
    ...
    models = {
        u'contact.contact': {
            ...
            'fullname': ('django.db.models.fields.CharField', [], {'max_length': '300', 'null': 'True', 'blank': 'True'}),
