...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Address.title'
        db.delete_column(u'profiles_address', 'title')

        # Adding field 'Address.full_name'
        db.add_column(u'profiles_address', 'full_name',
                      self.gf('django.db.models.fields.CharField')(max_length=120, null=True, blank=True),
                      keep_default=False)


        # Changing field 'Address.state'
        db.alter_column(u'profiles_address', 'state', self.gf('django.db.models.fields.CharField')(max_length=300))

    def backwards(self, orm):
        # Adding field 'Address.title'
        db.add_column(u'profiles_address', 'title',
                      self.gf('django.db.models.fields.CharField')(max_length=150, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Address.full_name'
        db.delete_column(u'profiles_address', 'full_name')


        # Changing field 'Address.state'
        db.alter_column(u'profiles_address', 'state', self.gf('django.db.models.fields.CharField')(max_length=200))
    ...
    models = {
        ...
        u'profiles.address': {
            ...
            'full_name': ('django.db.models.fields.CharField', [], {'max_length': '120', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
