...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CartItem.total'
        db.add_column(u'cart_cartitem', 'total',
                      self.gf('django.db.models.fields.DecimalField')(default=0.0, max_digits=1000, decimal_places=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CartItem.total'
        db.delete_column(u'cart_cartitem', 'total')
    ...
    models = {
        ...
        u'cart.cartitem': {
            ...
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'total': ('django.db.models.fields.DecimalField', [], {'default': '0.0', 'max_digits': '1000', 'decimal_places': '2'})
        },
