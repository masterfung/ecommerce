...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'orders_order', 'address',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['profiles.Address'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Order.cc_four'
        db.add_column(u'orders_order', 'cc_four',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'orders_order', 'address_id')

        # Deleting field 'Order.cc_four'
        db.delete_column(u'orders_order', 'cc_four')
